// src/lib.rs
/*
 * Core library for JenkinsPipeline
 */
...
#[derive(Debug)]
pub struct JenkinsPipelineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JenkinsPipelineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JenkinsPipeline processing");
    
    let mut processor = JenkinsPipelineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JenkinsPipelineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JenkinsPipelineProcessor::new(false);
